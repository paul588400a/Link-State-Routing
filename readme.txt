...
On the next line is the connection to other routers using "id" and followed by the "cost" of the connection(one line per connection).
The default cost of a connection is 1, if you aren't specified.
In the above case, the cost from router0 to router1 is 4. The cost from router2 to router3 is 1.
